  ...
  return (
    <>
      ...
      <Sliders
        ...
        personText=" / person"
        setData={setData}
        heading="Roaming Route's Mindful Retreats"
        data={data}
        mt="12%"
      />
      <Sliders
      ...
      <Text ml="4%" fontSize={"16px"}>
        ...
        Roaming Routes has curated several travel packages covering some of the
        most popular holiday destinations for you!
      </Text>
      <Flex
        mx="2%"
        display={"flex"}
      ...
      <Heading
        ...
        fontSize={{ base: "20px", lg: "28px" }}
      >
        Discover the best tour packages on Roaming Routes
      </Heading>
      <Text
        mx="4%"
        fontSize={"16px"}
      ...
      >
        ...
        while to experience the magic of travel. Roaming Routes offers some of
        the best tour packages and customised holidays in India and abroad to
        help you unwind and discover the world. On offer are a range of travel
        ...
        Roaming Routes are handpicked to cater to a variety of travel styles and
        requirements.
      </Text>
      ...
      <Text
        ...
        lineHeight={"29px"}
      >
        There is something for everyone who visits on Roaming Routes platform.
      ...
      <Heading
        ...
        fontSize={{ base: "20px", lg: "28px" }}
      >
        How to book holidays with Roaming Routes?
      </Heading>
      <Text
        mx="4%"
        fontSize={"16px"}
        ...
        lineHeight={"29px"}
      >
        Booking holidays on Roaming Routes is as easy as it gets. Pick from
        hundreds of packages. We will then connect you with your choices of
        travel providers via email and/or phone. Roaming Routes partners with
        ...
        packages on Roaming Routes.
        <br />
        <b>Step 1:</b> Click on the 'Book Holidays' button on the top right
        corner of any page on Roaming Routes. <br /> <b>Step 2:</b> You will be
      ...
      <Heading
        ...
        fontSize={{ base: "20px", lg: "28px" }}
      >
        Why book holidays with Roaming Routes?
      </Heading>
      <Text
        mx="4%"
        fontSize={"16px"}
        ...
        lineHeight={"29px"}
      >
        <span style={{ color: "#2f9bdb" }}>Roaming Routes 's</span> travel
        partners provide some of the best India tour packages and International
        tour packages. We are passionate about travel and strive to offer
        experiences that matter. We have a team of experienced travellers who
        can help you curate & plan the ideal getaway!
      </Text>
